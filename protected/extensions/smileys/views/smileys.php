<div class="<?php echo $containerCssClass;?>">
    ...
    ?>
    <div class="<?php echo $wrapperCssClass;?>">
        <a href="javascript:;" onclick="addSmiley('<?php echo CHtml::encode($smiley);?>','<?php echo $textareaId;?>');">
            <img src="<?php echo $image;?>" width="<?php echo $width;?>" height="<?php echo $height;?>" alt="<?php echo $alt;?>" title="<?php echo $title;?>"/>
        </a>
    </div>
    <?php if($perRow > 0 && $i % $perRow == 0):?><div class="clear">&nbsp;</div><?php endif;?>
    <?php endforeach;?>
</div>
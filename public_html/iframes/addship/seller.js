...
function handleComplete() {
    ...
    exportRoot.ship.type.gotoAndStop(0);
    ...
    exportRoot.ship.engine.gotoAndStop( Math.floor( exportRoot.ship.engine.timeline.duration/2 * Math.random() )  );
    exportRoot.ship.gun.gotoAndStop( Math.floor( exportRoot.ship.gun.timeline.duration/2 * Math.random() )  );

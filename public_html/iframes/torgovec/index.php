...
<canvas id="canvas" width="428" height="380" style=""></canvas>


<div class="player dialog" >
    <img src="/images/player_seller.png" class="img_person"  width="35"> <span class="text_comand"></span>
</div>

<div class="stantion dialog" >
    <img src="/images/stantion_demo.png" class="img_person" width="35"> <span class="text_comand"></span>
</div>

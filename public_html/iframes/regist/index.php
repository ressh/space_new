...
<canvas id="canvas" width="480" height="400" style=""></canvas>

<div class="player dialog" >
    <img src="/images/player_demo.png" class="img_person"  width="35"> <span class="text_comand"></span>
</div>

<div class="girlfriend dialog" >
    <img src="/images/girlfriend.png" class="img_person" width="35"> <span class="text_comand"></span>
</div>

<div class="general dialog" >
    <img src="/images/general.png" class="img_person" width="35"> <span class="text_comand"></span>
</div>

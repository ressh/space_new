...
(lib.Client = function() {
	...
	mask._off = true;
	mask.graphics.p("EgruAaKMAAAg0UMBXdAAAMAAAA0Ug");
	mask.setTransform(280,167.5);

	// Layer 6
	this.space = new lib.Symbol9();
	this.space.setTransform(1812,167.6,1.162,1.196,0,0,0,1560,140.1);

	this.space.mask = mask;

	this.addChild(this.space);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,3624,335);
...
(lib.Bullet2 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#99FF33","rgba(255,255,255,0)"],[0,1],0,0,0,0,0,23.6).s().p("AihCiQhEhDAAhfQAAheBEhDQBDhEBeAAQBfAABDBEQBEBDAABeQAABfhEBDQhDBEhfAAQheAAhDhEg");

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-22.9,-22.9,46,46);
...
(lib.Bullet = function() {
	...
	this.instance.setTransform(0,0,0.224,0.224,0,-89.9,90);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,5.6,28);
...
(lib.ShepFly = function() {
	...
	// Layer 1
	this.engine_work = new lib.Symbol3();
	this.engine_work.setTransform(-97.9,58.6,3.084,1.925,90,0,0,10.9,59.6);

	this.back_layer = new lib.Symbol4();
	this.back_layer.setTransform(12.9,-27.1,1,1,0,0,0,76.6,58.5);

	this.addChild(this.back_layer,this.engine_work,this.layer,this.defend);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-212.9,-104.1,377.3,206.2);
